...
import com.MyMall.pojo.ResultDT;
import com.MyMall.service.ICommentService;
import com.MyMall.util.ResultDTUtils;
...
public class CommentsController {
     ...
     * @return
     */
    @RequestMapping(value = "addRootComments.do",method = RequestMethod.POST)
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "addSonComments.do",method = RequestMethod.POST)
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "isLike.do",method = RequestMethod.POST)
    @ResponseBody
